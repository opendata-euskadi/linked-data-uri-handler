...
public class R01HPortalPageAppEmbedMetricsHelp {
/////////////////////////////////////////////////////////////////////////////////////////
//	FIELDS
/////////////////////////////////////////////////////////////////////////////////////////
	/**
	 ...
	 */
	private final R01HPortalPageAppEmbedMetrics _metrics;
/////////////////////////////////////////////////////////////////////////////////////////
//  CONSTRUCTOR
/////////////////////////////////////////////////////////////////////////////////////////
	public R01HPortalPageAppEmbedMetricsHelp(final R01HPortalPageAppEmbedMetrics metrics) {
		_metrics = metrics;
	}
/////////////////////////////////////////////////////////////////////////////////////////
//	METHODS
/////////////////////////////////////////////////////////////////////////////////////////
	...
	public void refreshMetrics(final Writer w,final boolean compact) throws IOException {
		if (compact) {
			R01HPortalPageAppEmbedMetricsReporter.of(_metrics.getRegistry())
	...
	private void _renderMetrics(final Writer w) throws IOException {
		...
		w.write(		"<input type='hidden' id='r01hCmd' name='r01hCmd' value='refreshMetrics'/>\n");
		w.write(		"<div class='form-group'>\n");
		w.write(			"<button type='button' class='btn btn-primary' id='btnRefreshMetrics'>Refresh Metrics</button>\n");
		w.write(			"<label><input type='checkbox' name='r01hCompactMetricsReport' id='r01hCompactMetricsReport'/>Compact report</label>\n");
		w.write(		"</div>\n");
		w.write(	"</form>\n");
	...
	private void _renderMetricsHelp(final Writer w) throws IOException {
		...
		w.write(	"<p>Metrics are configured at r01hp.portalpageappembedfilter.properties.xml config file</p>\n");
	...
	private static void _renderMetricsNotAvailable(final Writer w) throws IOException {
		...
		w.write(	"<p>Metrics can be enabled at r01hp.portalpageappembedfilter.properties.xml config file</p>\n");
		w.write("</div>\n");
	}
}
