 ...
 */
@Slf4j
public class R01HUserAgentParser 
  implements UserAgentStringParser,
  			 ServiceHandler {
/////////////////////////////////////////////////////////////////////////////////////////
// FIELDS
/////////////////////////////////////////////////////////////////////////////////////////
	private final Cache<String,R01HUserAgentData> _uaCache = CacheBuilder.newBuilder()
																		 .maximumSize(100)
...
/////////////////////////////////////////////////////////////////////////////////////////
	...
	public R01HUserAgentData from(final HttpServletRequest req) {
	...
	private Callable<R01HUserAgentData> _userAgentDataFrom(final String userAgentString) {	
		return new Callable<R01HUserAgentData>() {
						@Override
						public R01HUserAgentData call() throws Exception {
							R01HUserAgentData uaData = new R01HUserAgentData(userAgentString,
