/*
 * ---- PortalServletOutputStream.java ----
 * @author IE00165H
 ...
 *                           |                             302 - /r01hpProxyFOO/fooWar/baz   			<--- WRON!!! it should have been 302 - /fooWar/baz
 *                           V                                          |
 *          -------------------------------    APACHE    -------------------------------
 *                           |                                          ^
 *        /r01hpProxyWAR/r01hProxyFOO/fooWar/bar                         |
 *                           |                        302 - /r01hpProxyWAR/r01hProxyFOO/fooWar/baz
 *                           V                                          |
 *          -------------------------------  PROXY R01H  -------------------------------
 *                           |                                          ^
 *                     /fooWar/bar                                      |
 ...
 */
@Slf4j
  class R01HFakeServletResponseWrapper
extends R01HFakeStatusCodeCapturingResponseWrapper {
///////////////////////////////////////////////////////////////////////////////////////////
//  FIELDS
///////////////////////////////////////////////////////////////////////////////////////////
	// a type that logs the request / response through the filter
	private final R01HPortalPageAppEmbedServletFilterLogger _requestLogger;
	
	// Stores the headers set by the proxied app server
    private final Map<String,String> _headers;

    // Stores ALL the output returned by the proxied app server
	private final R01HFakeServletResponseOutputStream _responseOutputStream;
...
//  CONSTRUCTOR
/////////////////////////////////////////////////////////////////////////////////////////
	public R01HFakeServletResponseWrapper(final HttpServletResponse realHttpResponse,
										  final R01HPortalPageAppEmbedServletFilterLogger requestLogger) {
	    super(realHttpResponse);
	    _responseOutputStream = new R01HFakeServletResponseOutputStream(requestLogger);
