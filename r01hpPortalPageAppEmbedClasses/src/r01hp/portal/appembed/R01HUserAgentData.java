...
//  
/////////////////////////////////////////////////////////////////////////////////////////
	public R01HUserAgentData(final String userAgentString,
...
/////////////////////////////////////////////////////////////////////////////////////////
	...
	private static Observable<String> _observableFrom(final int indent,
		...
		return Observable.from(props.entrySet())
					     .flatMap(new Func1<Map.Entry<String,Object>,Observable<String>>() {
											@Override @SuppressWarnings("unchecked")
											public Observable<String> call(final Entry<String,Object> me) {
