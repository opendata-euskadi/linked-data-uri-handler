...
@Slf4j
public class R01HTestLODURIHandlerForSPARQLURIs 
...
/////////////////////////////////////////////////////////////////////////////////////////	
	...
	public void testSPARQLURIs() {
		...
		UrlPath sparqlUrlPath = R01HLODURIType.SPARQL.getPathToken();
		UrlQueryString sparqlQuery = UrlQueryString.fromParams(UrlQueryStringParam.of("query","an sparql query")); 
		
		R01HLODURIHandlerForSPARQLQuery resHandler = new R01HLODURIHandlerForSPARQLQuery(config);
