...
/**
 * R01H API {@link UserContext} implementation
 */
@MarshallType(as="context")
@Accessors(prefix="_")
@NoArgsConstructor
public class R01HSecurityContext 
...
/////////////////////////////////////////////////////////////////////////////////////////
	/**
	 * This constructor is MANDATORY since {@link R01HSecurityContext} is mapped as a @HeaderParam
	 * at REST jesrouces.
	 ...
	 * @param usrContextXML
	 */
	public R01HSecurityContext(final String usrContextXML) {	
...
//		_createDate = new Date();
	 ...
	 * @param appCode 
	 */
	public R01HSecurityContext(final AppCode appCode) {
	 ...
	 * @param userCode
	 */
	public R01HSecurityContext(final UserCode userCode) {
	 ...
	 * @param authActor
	 */
	public R01HSecurityContext(final AuthenticatedActorID authActor) {
		this(authActor,
			 TenantID.DEFAULT);
	}
	/**
